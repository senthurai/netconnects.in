   ...
   function tilesController() {
     ...
     ctrl.diff = function(data) {
       if (data) {
         return Math.abs(data.bnkrTtlVl - data.plyrTtlVl);
       }
       return 0;

     }
     ctrl.getOpacity = function(data) {
       return 10 - ctrl.diff(data);
     }
     ...
     ctrl.isHighDiff = function($ctrl) {
       ...
       var b3 = p13 ? p13 : false;
       var p3 = p23 ? p23 : false;
       return (!isNtrl(p3, b3, b, p)) && (!isNtrl(p3, b3, p, b)) && ((p - b > 8) || (p - b < -8)); // drag;
     }
